...
from django_slack_app.views import SlackCommandView, SlackEventView, SlackOAuthView
...
urlpatterns = [
    ...
    path("done", TemplateView.as_view(template_name="django_slack_app/oauth_done.html"), name="oauth_done"),
]
